...
# Mirrors config_and_run.sh's proven CPU env, but:
...
#     bash config_and_run_baseline.sh
set -euo pipefail
...
name="CDKL5_baseline_2026-07-14"
params="evol_params_large_limited_tau"

echo "=== BASELINE evol run (NO drugs) | name=$name params=$params ==="
