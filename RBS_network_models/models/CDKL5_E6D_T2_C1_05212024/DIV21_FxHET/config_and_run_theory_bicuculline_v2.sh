...
#
# VERSION 2: fresh run name so output does not land on top of the 2026-07-20 run.
#
...
#   bash config_and_run_theory_bicuculline_v2.sh
#
...
name="CDKL5_theory_bicuc_2026-07-21_v2"
...
python /pscratch/sd/k/ktub1999/networkSimulations/RBS_network_models/RBS_network_models/models/CDKL5_E6D_T2_C1_05212024/DIV21_FxHET/run_batch.py \
    ...
    --maxiters 40 \
    --pop_size 1 \
    --batch_label batch_2026-07-21_theory_bicuculline_v2 \
    --drug_target theory \
    --drugs bicuculline
