#Original SChema before schema2
...
fit_schema = {
    ...
    'spiking_data':{
        'spike_times': True,
        'spiking_times_by_unit': True,
        'spiking_metrics_by_unit': True,
    ...
    'bursting_data_v2': {
    # Burstlets - Fast, small bursts
    'burst_ids': False,
    'burstlets': {
        'include': True,  # Set to True when ready to use
        'burst_rate': {
            'include': True,
            'min_val': 0.1,
            'max_val': 5.0,
        ...
        'burst_duration': False,
        'burst_amp': False,
        'synchrony_energy': False,
        'participation': False,
        'burst_ids':False,
        'events':False
    },
    
    # Network bursts - Merged medium-scale bursts
    'network_bursts': {
        'include': True,  # Main burst level to optimize
        'burst_rate': {
            'include': True,
            'min_val': 0.02,
            'max_val': 1.0,
    ...
    # Superbursts - Long clustered events
    'superbursts': {
        'include': True,
        'burst_rate': {
            'include': True,
    ...
    # Baseline from slow smoothed signal
    'baseline': {
        'include': True,
        'min_val': 2.0,
        'max_val': 4.0,
    ...
    # Diagnostics (informational, not for fitness)
    'diagnostics': False,
