...
if version == 3.0:
    ...
    params['propVelocity'] = [0.423701682906636, 100]
    ...
    params.update({
        ...
        'weightEI_AMPA': [0.431725321466, 1428.0874898827226],
        'weightEE_AMPA': [0.890562150114, 18306.082472564497],

        # NMDA-mediated weights (blocked by AP5)
        'weightEI_NMDA': [0.431725321466, 1428.0874898827226],
        'weightEE_NMDA': [0.890562150114, 18306.082472564497],

        # GABA-mediated weights (blocked by Bicuculline / Gabazine)
        'weightIE_GABA': [0, 2776.131109745544],
        'weightII_GABA': [0, 18855.182424835687],
    })
