...
if version == 2.0:
    ...
    params.update({
        ...
        'E_diam_stdev': [0, 0],  # Fixed to 0: all E cells get identical diam (= E_diam_mean)
        'E_L_stdev': [0, 0],  # Fixed to 0: all E cells get identical L (= E_L_mean)
        'E_Ra_stdev': [0, 0],  # Fixed to 0: all E cells get identical Ra (= E_Ra_mean)

        'I_diam_stdev': [0, 0],  # Fixed to 0: all I cells get identical diam (= I_diam_mean)
        'I_L_stdev': [0, 0],  # Fixed to 0: all I cells get identical L (= I_L_mean)
        'I_Ra_stdev': [0, 0],  # Fixed to 0: all I cells get identical Ra (= I_Ra_mean)
