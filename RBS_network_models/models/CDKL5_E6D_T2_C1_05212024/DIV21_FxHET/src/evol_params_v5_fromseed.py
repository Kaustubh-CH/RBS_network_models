...
if version == 5.0:
    ...
    params.update({
        ...
        'weightEI_AMPA': [552.6010560527714, 1657.803168158314],
        'weightEE_AMPA': [2071.964001591286, 6215.8920047738575],

        # NMDA-mediated weights (blocked by AP5)
        'weightEI_NMDA': [318.7765500274295, 956.3296500822885],
        'weightEE_NMDA': [3732.9501194660797, 11198.850358398238],

        # GABA-mediated weights (blocked by Bicuculline / Gabazine)
        'weightIE_GABA': [1.8618, 5.5854],
        'weightII_GABA': [22.32675, 66.98025],
    })
