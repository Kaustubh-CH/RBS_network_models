...
CFG=/pscratch/sd/k/ktub1999/networkSimulations/z_simulated_data/CDKL5_seed_large_limited_tau_2_w1_FixedPropVel/batch_runs/batch_2026-07-01_spiking_only/gen_157/trial_157_cfg.json

srun -n 128 nrniv -mpi -python rerun_trial_save_spikes_conn.py \
    "$CFG" \
    --duration-seconds 300 \
    --fixed-dt \
    --output-dir ./op_300s_trial157/
